  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      <div
        ...
        style={{
          backgroundImage: 'linear-gradient(hsl(244,100%,69%) 1px, transparent 1px), linear-gradient(90deg, hsl(244,100%,69%) 1px, transparent 1px)',
          backgroundSize: '48px 48px',
        }}
      />
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[900px] h-[500px] bg-primary/10 rounded-full blur-[160px]" />
